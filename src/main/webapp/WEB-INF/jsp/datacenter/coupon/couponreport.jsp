...
<body class="no-skin">
    <div class="main-container" id="main-container" style="padding: 5px;">
        ...
        <form action="couponReport/couponReport" method="post" name="Form" id="Form">
            <table style="margin-top:5px; margin-left: 60px;">
                ...
                <td style="vertical-align:top;padding-left:6px"><a class="btn btn-light btn-xs" onclick="queryCoupon();"  title="查询"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
                </tr>
            </table>
            <!-- 检索  -->
        </form>
            ...
            <div class="widget-box transparent" id="recent-box">
                <div class="widget-header">
                    <h4 class="widget-title lighter smaller">
                        <i class="ace-icon fa fa-rss orange"></i>优惠券数据分析
                    </h4>

                    <div class="widget-toolbar no-border">
                        <ul class="nav nav-tabs" id="recent-tab">
                            <li class="active">
                                <a data-toggle="tab" href="#task-tab" aria-expanded="true">优惠券消费情况</a>
                            </li>
                            <%--<li class="">
    ...
    <!-- Ajax异步请求数据-->
    <script src="static/js/coupon/couponreport.js"></script>
    <!-- Ajax异步请求数据-->
