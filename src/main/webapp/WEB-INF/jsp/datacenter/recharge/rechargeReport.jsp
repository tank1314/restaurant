...
<body class="no-skin">
    <div class="main-container" id="main-container" style="padding: 5px;">
        ...
        <form action="busorderreportData/list" method="post" name="Form" id="Form">
            <table style="margin-top:5px; margin-left: 60px;">
                ...
                <td style="vertical-align:top;padding-left:6px"><a class="btn btn-light btn-xs" onclick="queryCity();queryConsum();"  title="查询"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
                </tr>
            </table>
            <!-- 检索  -->
        </form>
            ...
            <div class="widget-box transparent" id="recent-box">
                <div class="widget-header">
                    <h4 class="widget-title lighter smaller">
                        <i class="ace-icon fa fa-rss orange"></i>充值数据分析
                        <span style="display: none;color: black" id="contentczDiv"></span>
                    </h4>

                    <div class="widget-toolbar no-border">
                        <ul class="nav nav-tabs" id="recent-tab">
                            <li class="active" id="czDiv">
                                <a data-toggle="tab" href="#task-tab" aria-expanded="true">充值金额</a>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="#member-tab" aria-expanded="false">金额梯度</a>
                            </li>
                            <li class="">
                            ...
                            <div id="member-tab" class="tab-pane">
                                ...
                                <div class="clearfix">
                                    <div class="itemdiv zdy">
                                        <div id="dataInfomoneysh" style="display: none;"></div>
                                        <div id="dataInfomoneysz" style="display: none;"></div>
                                        <div id="dataInfomoneyhz" style="display: none;"></div>
                                    </div>
                                </div>
    ...
    <!-- Ajax异步请求数据-->
    <script src="static/js/recharge/recharge.js"></script>
    <!-- Ajax异步请求数据-->
