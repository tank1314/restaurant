...
<body>
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute; background:#F6EEE1 " >
		<div id="loginbox" style="right: auto">
			<form action="" method="post" name="loginForm"
				id="loginForm">
				<div class="control-group normal_text">
					<h3>
						<font color="white"><span id="nameerr">数据中心1.0</span></font>
					</h3>
				</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white" ><span id="nameerr">Copyright©2016 上海腾牛电子商务有限公司 </span></font>
				</div>
			</div>
		</div>
	</div>
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			<div data-src="static/login/images/background-2.png"></div>
			<div data-src="static/login/images/background-2.png"></div>
		</div>
		<!-- #camera_wrap_3 -->
	</div>
