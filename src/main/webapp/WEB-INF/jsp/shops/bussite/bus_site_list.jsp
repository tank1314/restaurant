...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="sitelist/siteBybusList.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="bus_id" id="bus_id" data-placeholder="请选择商户列表" style="vertical-align:top;width: 140px;">
									<option value=""></option>
								...
								<c:when test="${not empty siteList}">
									...
									<c:forEach items="${siteList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.site_area}</td>
											<td class='center'>${var.service_type}</td>
											<td class='center'>${var.siteaddress}</td>
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=path%>alliancebusiness/excel.do';
		}
	</script>
</body>
</html>