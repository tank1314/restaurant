			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="bussiteReport/orderList.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入订单编号、通讯地址" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入关键词" style="vertical-align:top;width: 200px;"/>
                                ...
                                <%--<td style="vertical-align:top;padding-left:2px;">
                                    <select class="chosen-select form-control" name="is_cancel" id="is_cancel" data-placeholder="订单是否取消" style="vertical-align:top;width: 140px;">
                                        <option value=""></option>
                                        <option value="">--请选择--</option>
                                        <option value="0" <c:if test="${pd.is_cancel == '0'}">selected="selected" </c:if>>未取消</option>
                                        <option value="1" <c:if test="${pd.is_cancel == '1'}">selected="selected" </c:if>>已取消</option>
                                    </select>
                                </td>--%>
                                <td style="vertical-align:top;padding-left:2px;">
