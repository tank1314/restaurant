				...
				<div class="row">
					...
					<form action="alliancebusiness/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:105px;text-align: right;padding-top: 13px;">押　金(分):</td>
								<td><input type="text" name="deposit" id="deposit" value="${pd.deposit}" maxlength="255" placeholder="这里输入押金(分)" onkeyup="value=this.value.replace(/\D+/g,'')" title="押金" style="width:98%;"/></td>
							</tr>
							<tr>
