...
<body>
<div id="siteDiv" style="width: 100%;height: 120px;margin-top: 0px;">
    <table style="margin-top:5px;">
        <tr>
            <td style="vertical-align:top;padding-left:2px;">
                <h4>站点列表:</h4>
                <c:forEach items="${pd.siteList}" var="site">
                    <input checked  class="ace" type="checkbox" name="site_sid" value="${site.site_sid}"/><span class="lbl">${site.site_name}</span>
                </c:forEach>
            </td>
        </tr>
    </table>
</div>
<div id="container" style="width: 100%;height: auto;margin-top: 100px;"></div>
<!-- 页面底部js¨ -->
...
<script>
    ...
    function tosearch() {
        map.clearMap();
        $.ajax({
            url:"FLTSiteDistribution/querySelfJiazhengSiteList",
            type:'post',
            dataType:'json',
