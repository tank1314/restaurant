							...
							<c:choose>
								<c:when test="${r"${not empty varList}"}">
									...
									<c:forEach items="${r"${varList}"}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${r"${var."}${objectNameLower}_id${r"}"}" class="ace" /><span class="lbl"></span></label>
											</td>
										...
										<#list fieldList as var>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${r"${var."}${objectNameLower}_id${r"}"}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													</c:if>
													<c:if test="${r"${QX.del == 1 }"}">
													<a class="btn btn-xs btn-danger" onclick="del('${r"${var."}${objectNameLower}_id${r"}"}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${r"${QX.edit == 1 }"}">
															<li>
																<a style="cursor:pointer;" onclick="edit('${r"${var."}${objectNameLower}_id${r"}"}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${r"${QX.del == 1 }"}">
															<li>
																<a style="cursor:pointer;" onclick="del('${r"${var."}${objectNameLower}_id${r"}"}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
